    ...
    <div class="h-screen flex flex-col overflow-y-auto" ref="chatContainer">
      ...
      <div v-if="userStore.isAdmin" class="fixed top-4 right-4 z-10">
        ...
        <ChatInputBox v-model="chatMessage" containerClass="sticky max-w-3xl mx-auto bg-white bottom-8 left-0 w-full"
          @sendMessage="sendMessage" placeholder="向Vin面试专栏 AI 智能客服询问" :showModelDropdown="false" :showNetworkSearch="false"/>
...
// 聊天记录，默认给一个欢迎语
const chatList = ref([{ role: 'assistant', content: '你好呀！我是 “Vin面试专栏” 的 AI 智能客服，基于 Spring AI 开发，欢迎向我咨询项目相关问题哈 😁', loading: false }])
